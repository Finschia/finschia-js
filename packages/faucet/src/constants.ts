...
export const binaryName = "finschia-faucet";
export const memo: string | undefined = process.env.FAUCET_MEMO;
export const gasPrice = GasPrice.fromString(process.env.FAUCET_GAS_PRICE || "0.01cony");
...
export const addressPrefix = process.env.FAUCET_ADDRESS_PREFIX || "link";
export const pathPattern = process.env.FAUCET_PATH_PATTERN || "m/44'/438'/2'/0/a";
export const tokenConfig: TokenConfiguration = {
  bankTokens: parseBankTokens(process.env.FAUCET_TOKENS || "cony"),
};
/**
