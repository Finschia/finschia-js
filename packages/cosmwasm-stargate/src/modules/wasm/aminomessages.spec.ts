      ...
      // With admin
      {
        ...
        const expected: AminoMsgInstantiateContract = {
          ...
          value: {
            ...
            code_id: "12345",
            label: "sticky",
            // todo: we need to fix the msg representation of lbm-sdk's wasm proto. refer https://github.com/CosmWasm/wasmd/pull/658
            // msg: { foo: "bar" },
    ...
    it("works for MsgExecuteContract", () => {
      ...
      const expected: AminoMsgExecuteContract = {
        ...
        value: {
          ...
          contract: "cosmos1xy4yqngt0nlkdcenxymg8tenrghmek4nmqm28k",
          // msg: { foo: "bar" },
          msg: toBase64(toUtf8(JSON.stringify({ foo: "bar" }))),
          funds: coins(1234, "cony"),
        },
      };
      expect(aminoMsg).toEqual(expected);
