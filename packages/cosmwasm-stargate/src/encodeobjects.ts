...
export function isMsgStoreCodeEncodeObject(
  ...
  return (encodeObject as MsgStoreCodeEncodeObject).typeUrl === "/lbm.wasm.v1.MsgStoreCode";
}
...
export function isMsgInstantiateContractEncodeObject(
  ...
  return (
    (encodeObject as MsgInstantiateContractEncodeObject).typeUrl === "/lbm.wasm.v1.MsgInstantiateContract"
  );
}
...
export function isMsgUpdateAdminEncodeObject(
  ...
  return (encodeObject as MsgUpdateAdminEncodeObject).typeUrl === "/lbm.wasm.v1.MsgUpdateAdmin";
}
...
export function isMsgClearAdminEncodeObject(
  ...
  return (encodeObject as MsgClearAdminEncodeObject).typeUrl === "/lbm.wasm.v1.MsgClearAdmin";
}
...
export function isMsgMigrateEncodeObject(
  ...
  return (encodeObject as MsgMigrateContractEncodeObject).typeUrl === "/lbm.wasm.v1.MsgMigrateContract";
}
...
export function isMsgExecuteEncodeObject(
  ...
  return (encodeObject as MsgExecuteContractEncodeObject).typeUrl === "/lbm.wasm.v1.MsgExecuteContract";
}
