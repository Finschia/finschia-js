import * as ibcTest from "@cosmjs/cosmwasm-stargate";
...
//           clientState: {
//             typeUrl: "/ibc.lightclients.ostracon.v1.ClientState",
...
//         expect(response.consensusState).toEqual({
//           typeUrl: "/ibc.lightclients.ostracon.v1.ConsensusState",
//           value: jasmine.any(Uint8Array),
//         });
...
//           allowedClients: ["06-solomachine", "99-ostracon"],
//         });
